---
title: "Assignmement-DataVis-ggplot"
author: "YOUR NAME HERE"
date: 'Complete on your own time'
output:
...
- **files:** bloom_df.csv, assignment_task2_blank.png
...
setwd('~/g/parchman/GAIN/GAIN_summer2022/day2_datavis/assignment') #change to match your ggplot directory
...
##### Example layout:   
![sample layout for task2](assignment_task2_blank.png){width=50%}
